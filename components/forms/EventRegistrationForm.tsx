...
export function EventRegistrationForm({ eventId, eventTitle }: { eventId: string; eventTitle: string }) {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center gap-3 rounded-2xl bg-brand-teal-50 p-8 text-center">
        ...
        <h3 className="font-bold text-brand-teal-900">You&rsquo;re registered!</h3>
        <p className="text-sm text-brand-grey-500">We look forward to seeing you at {eventTitle}.</p>
      </div>
    );
  }
  ...
  return (
    <form
      ...
      noValidate
    >
      <h3 className="font-bold text-brand-teal-900">Register for this event</h3>
