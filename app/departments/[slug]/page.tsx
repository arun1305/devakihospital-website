    ...
    <>
      ...
      <section className="bg-white py-20 dark:bg-brand-teal-950">
        <Container className="flex flex-col gap-12">
          <div className={cn("grid gap-10", department.heroImage && "lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch")}>
            ...
            {department.heroImage && (
              <RevealOnScroll direction="left" delay={0.1} className="h-full">
                <div className="relative h-full min-h-[280px] w-full overflow-hidden rounded-3xl shadow-brand-soft ring-1 ring-brand-grey-200 dark:ring-white/10">
                  <Image
